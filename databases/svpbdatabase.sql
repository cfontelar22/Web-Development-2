...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 05:11 PM
...
(2, 'Motherboards'),
(3, 'Memory (RAM)'),
(4, 'Storage Drives (SSDs and HDDs)'),
(5, 'Graphics Cards'),
(6, 'Power Supplies (PSUs)'),
(7, 'Cooling Solutions (CPU coolers and case fans)'),
(8, 'Network Interface Cards (NICs)'),
(9, 'Input Devices (Keyboards, Mice, etc.)'),
(10, 'Monitors'),
(11, 'Printers and Scanners'),
(12, 'Security Solutions'),
(13, 'Network Solutions and Structured Cabling'),
(14, 'Information and Communication Technology Infrastructure');
